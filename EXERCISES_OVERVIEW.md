...
**完整练习列表**: 33个练习 | **总题目数**: 99+道题 | **难度体系**: 三级渐进
...
### 🎲 20. 贝叶斯推断（Bayesian Inference）- 1个练习

#### ex01_bayesian_basics.py - 贝叶斯推断基础 ⭐⭐⭐
**三级结构**：
- **初级**: 贝叶斯定理和先验后验 (贝叶斯定理, Beta-Binomial共轭更新, 离散后验)
- **中级**: 共轭先验和贝叶斯估计 (Gaussian-Gaussian更新, MAP估计, 可信区间)
- **高级**: MCMC采样和贝叶斯推断 (Metropolis-Hastings, 贝叶斯因子, 重要性采样)

**知识点**: 贝叶斯定理 | 共轭先验 | MCMC采样 | 后验分布
**应用**: 贝叶斯机器学习 | 概率图模型 | A/B测试 | 变分推断

**参考教材**: Gelman - Bayesian Data Analysis | Bishop - Pattern Recognition Ch.2

---

### 🎯 21. 核方法（Kernel Methods）- 1个练习

#### ex01_kernel_basics.py - 核方法基础 ⭐⭐⭐
**三级结构**：
- **初级**: 核函数和核矩阵 (线性/多项式/RBF核, 核矩阵正定性)
- **中级**: 核技巧和RKHS (核中心化, 核对齐, 核岭回归)
- **高级**: 核PCA和核方法应用 (核PCA, 核k-means, 高斯过程回归, MMD)

**知识点**: 核函数 | 核技巧 | RKHS | 高斯过程 | SVM
**应用**: 支持向量机 | 核PCA | 高斯过程 | 分布相似度度量

**参考教材**: Schölkopf & Smola - Learning with Kernels | Rasmussen - Gaussian Processes

---

### 🚀 22. 随机优化（Stochastic Optimization）- 1个练习

#### ex01_sgd_and_variants.py - SGD及其变体 ⭐⭐⭐
**三级结构**：
- **初级**: SGD和Mini-batch梯度下降 (批量GD, SGD, Mini-batch SGD)
- **中级**: Momentum和Nesterov加速 (动量SGD, Nesterov加速梯度, 学习率衰减)
- **高级**: 自适应学习率方法 (AdaGrad, RMSProp, Adam, AdamW, 梯度裁剪)

**知识点**: SGD | 动量方法 | Adam优化器 | 自适应学习率
**应用**: 深度学习训练 | 大规模机器学习 | 在线学习

**参考教材**: Goodfellow - Deep Learning Ch.8 | Ruder - Overview of Optimization Algorithms
...
### 🤖 传统机器学习
- **核心方法**:
  - 核方法 (ex01) - SVM, 核PCA, 高斯过程
  - 贝叶斯推断 (ex01) - 概率模型, MCMC
  - 优化 (全部)
- **基础数学**:
  - 线性代数 (全部)
  - 概率论: ex01
